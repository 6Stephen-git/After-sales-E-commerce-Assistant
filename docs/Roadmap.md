...
- [ ] 编写内嵌测试用例并全部通过
- [ ] 核心里程碑：Agent 1 独立可运行
- [ ] **合并到 dev，打 tag `v0.2.1-agent1`，更新 Changelog**
...
- [ ] 编写内嵌测试用例并全部通过
- [ ] 核心里程碑：Agent 2 独立可运行
- [ ] **合并到 dev，打 tag `v0.2.2-agent2`，更新 Changelog**

### Agent 3 话术生成员
- [ ] 实现 `agents/agent3/` 模块
- [ ] 编写内嵌测试用例并全部通过
- [ ] 核心里程碑：Agent 3 独立可运行
- [ ] **合并到 dev，打 tag `v0.2.3-agent3`，更新 Changelog**

### 辅助模式控制器
- [ ] 实现 `controllers/assisted_controller.py`
- [ ] 负责：拉取材料（首次全量 + 缓存，后续增量追加）→ 调用 Agent1 → Agent2 → Agent3 → 组装报告
- [ ] 编写集成测试用例并全部通过
- [ ] 核心里程碑：辅助模式完整链路可运行
- [ ] **合并到 dev，打 tag `v0.2.4-controller`，更新 Changelog**
